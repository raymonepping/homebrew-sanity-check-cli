class SanityCheckCli < Formula
  ...
  url "https://github.com/raymonepping/homebrew-sanity-check-cli/archive/refs/tags/v1.0.6.tar.gz"
  sha256 "effda2a6371a4e0b8d9fc5c4bdf66ca7b0411854f6affcfb72abcedef3dd4ae7"
  license "MIT"
  version "1.0.6"
